...
class TransferLearning(Trainer):
    def __init__(self, model, criterion, optimizer, scheduler, path_saved="", feature_extractor = True, data=None):
        image_transforms = {
            "train":
            transforms.Compose([
        ...
        super().__init__(model, image_transforms, criterion, optimizer, scheduler, path_saved, data)
